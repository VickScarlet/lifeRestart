(function(window){
    ...
    App.prototype = {
        ...
        initPages() {
            ...
            var createTalent = ({ grade, name, description }) => {
                ...
                this.life.talentRandom().forEach(talent=>{
                    ...
                    li.click(()=>{
                        if(li.hasClass('selected')) {
                            ...
                            var inx = this.talentSelected.indexOf(talent);
                            this.talentSelected.splice(0,inx);
                        } else {
            ...
            talentPage.find('#next').click(()=>{
                ...
                this.totalMax = 20 + this.life.getTalentAllocationAddition(this.talentSelected.map(({id})=>id));
            ...
            propertyPage.find('#start').click(()=>{
                ...
                this.life.restart({
                    ...
                    MNY: groups.MNY.get(),
                    SPR: 5,
                    TLT: this.talentSelected.map(({id})=>id),
                });
                ...
                summary: {
                    ...
                    clear: ()=>{
                        ...
                        judge.append([
                            ...
                            (()=>{
                                var m = type=>max(records.map(({[type]: value})=>value));
