import { max, sum, summaryData } from './functions/util.js';
    ...
    initPages() {
        ...
        trajectoryPage
            ...
            .click(() => {
                ...
                const li = $(`<li><span>${age}岁：</span>${content.map(
            ...
            summary: {
                ...
                clear: () => {
                    ...
                    if (talentBuffStr) {
                        ...
                        previous.randFix = talentBuff.randFix
                    }
                    judge.append([
                        (() => {
